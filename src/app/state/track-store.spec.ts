...
/** Configure TestBed with a stub Opencv service. */
function setupStore(warpImpl = () => makeCanvas()): TrackStore {
...
warpPerspective: vi.fn().mockImplementation(warpImpl),
},
},
],
});
return TestBed.inject(TrackStore);
}
